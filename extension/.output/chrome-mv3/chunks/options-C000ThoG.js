import{r as o,s as l,d as E,j as e,e as s,f as K,D as P,c as U,R as H}from"./storage-DF14hXSN.js";const q=`
...
`;function $(){const[c,L]=o.useState("api"),[t,i]=o.useState("openrouter"),[d,p]=o.useState(""),[m,b]=o.useState(""),[g,x]=o.useState(""),[u,h]=o.useState(""),[f,y]=o.useState(""),[k,j]=o.useState(""),[T,S]=o.useState(!1),G=r=>{const a=r.trim();a.startsWith("sk-or-v1-")?(y(a),i("openrouter")):a.startsWith("csk-")?(j(a),i("cerebras")):a.startsWith("gsk_")?(p(a),i("grok")):a.startsWith("sk-ant-")?(b(a),i("claude")):a.startsWith("AIzaSy")?(x(a),i("gemini")):a.startsWith("sk-")&&(h(a),i("openai"))},[v,w]=o.useState([]),[N,C]=o.useState("");o.useEffect(()=>{Promise.all([l("tabmind:grok:apiKey"),l("tabmind:claude:apiKey"),l("tabmind:gemini:apiKey"),l("tabmind:openai:apiKey"),l("tabmind:openrouter:apiKey"),l("tabmind:cerebras:apiKey"),l("tabmind:provider"),E()]).then(([r,a,n,A,B,I,F,R])=>{r&&p(r),a&&b(a),n&&x(n),A&&h(A),B&&y(B),I&&j(I),F&&i(F),w(R)})},[]);const M=async()=>{await Promise.all([s("tabmind:provider",t),s("tabmind:grok:apiKey",d.trim()),s("tabmind:claude:apiKey",m.trim()),s("tabmind:gemini:apiKey",g.trim()),s("tabmind:openai:apiKey",u.trim()),s("tabmind:openrouter:apiKey",f.trim()),s("tabmind:cerebras:apiKey",k.trim())]),chrome.runtime.sendMessage({type:"TABMIND_SNAPSHOT_NOW"}).catch(()=>{}),S(!0),setTimeout(()=>S(!1),3e3)},W=()=>t==="grok"?!!d.trim():t==="claude"?!!m.trim():t==="openai"?!!u.trim():t==="openrouter"?!!f.trim():t==="cerebras"?!!k.trim():!!g.trim(),_=async()=>{await Promise.all([s("tabmind:grok:apiKey",""),s("tabmind:claude:apiKey",""),s("tabmind:gemini:apiKey",""),s("tabmind:openai:apiKey",""),s("tabmind:openrouter:apiKey",""),s("tabmind:cerebras:apiKey","")]),p(""),b(""),x(""),h(""),y(""),j("")},z=async()=>{const r=N.trim().toLowerCase().replace(/^https?:\/\//,"").split("/")[0];if(!r||v.includes(r))return;const a=[...v,r];w(a),await K(a),C("")},O=async r=>{const a=v.filter(n=>n!==r);w(a),await K(a)},D=async()=>{w(P),await K(P)};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:q}),e.jsxs("div",{style:{marginBottom:32},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,marginBottom:6},children:[e.jsxs("svg",{width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",children:[e.jsx("defs",{children:e.jsxs("linearGradient",{id:"og",x1:"0",y1:"0",x2:"24",y2:"24",children:[e.jsx("stop",{offset:"0%",stopColor:"#a78bfa"}),e.jsx("stop",{offset:"100%",stopColor:"#6d28d9"})]})}),e.jsx("circle",{cx:"12",cy:"12",r:"9",stroke:"url(#og)",strokeWidth:"1.4",opacity:"0.55"}),e.jsx("ellipse",{cx:"12",cy:"12",rx:"9",ry:"3.6",stroke:"url(#og)",strokeWidth:"1.2",opacity:"0.4",transform:"rotate(-28 12 12)"}),e.jsx("circle",{cx:"12",cy:"12",r:"2.6",fill:"url(#og)"}),e.jsx("circle",{cx:"20",cy:"6.5",r:"1.5",fill:"#a78bfa"})]}),e.jsx("h1",{style:{fontSize:22,fontWeight:760,letterSpacing:"-0.03em"},children:"TabMind"}),e.jsx("span",{className:"tag",children:"Settings"})]}),e.jsx("p",{style:{fontSize:13.5,color:"#64748b",letterSpacing:"-0.005em"},children:"Configure your AI session tracker"})]}),e.jsx("div",{className:"tab-bar",children:["api","blocklist","about"].map(r=>e.jsx("button",{type:"button",className:`tab${c===r?" active":""}`,onClick:()=>L(r),children:r==="api"?"AI Provider":r==="blocklist"?"Privacy":"About"},r))}),c==="api"&&e.jsxs("div",{className:"card",children:[e.jsx("div",{className:"card-title",children:"AI Provider"}),e.jsx("label",{className:"label",children:"Paste any API key — provider auto-detected"}),e.jsx("input",{className:"input",type:"password",placeholder:"Paste key: sk-or-v1-… / csk-… / gsk_… / sk-ant-… / AIzaSy… / sk-…",autoComplete:"off",onChange:r=>G(r.target.value)}),e.jsxs("p",{className:"hint",style:{marginBottom:20},children:["Key prefix is recognized automatically. Active: ",e.jsx("strong",{style:{color:"#a78bfa"},children:t})]}),e.jsx("label",{className:"label",children:"Or choose provider manually"}),e.jsx("div",{className:"provider-grid",children:[{id:"openrouter",name:"OpenRouter",sub:"Llama 3.3 70B",free:!0},{id:"cerebras",name:"Cerebras",sub:"Llama 3.3 70B",free:!0},{id:"grok",name:"Groq",sub:"Llama 3.3 70B",free:!0},{id:"claude",name:"Claude",sub:"Haiku 4.5",free:!0},{id:"gemini",name:"Gemini",sub:"2.0 Flash",free:!0},{id:"openai",name:"OpenAI",sub:"GPT-4o mini",free:!1}].map(r=>e.jsxs("button",{type:"button",className:`provider-btn${t===r.id?" active":""}`,onClick:()=>i(r.id),children:[e.jsx("span",{className:"provider-name",children:r.name}),e.jsx("span",{className:"provider-sub",children:r.sub}),r.free&&e.jsx("span",{className:"free-badge",children:"free tier"})]},r.id))}),t==="openrouter"&&e.jsxs(e.Fragment,{children:[e.jsx("label",{className:"label",htmlFor:"openrouter-key",children:"OpenRouter API key"}),e.jsx("input",{id:"openrouter-key",className:"input",type:"password",value:f,onChange:r=>y(r.target.value),placeholder:"sk-or-v1-…",autoComplete:"off"}),e.jsxs("p",{className:"hint",children:["Key from ",e.jsx("a",{href:"https://openrouter.ai/keys",target:"_blank",rel:"noopener",children:"openrouter.ai/keys"}),". Uses ",e.jsx("strong",{style:{color:"#c4b5fd"},children:"Llama 3.3 70B"})," — free tier available, access to 300+ models."]})]}),t==="cerebras"&&e.jsxs(e.Fragment,{children:[e.jsx("label",{className:"label",htmlFor:"cerebras-key",children:"Cerebras API key"}),e.jsx("input",{id:"cerebras-key",className:"input",type:"password",value:k,onChange:r=>j(r.target.value),placeholder:"csk-…",autoComplete:"off"}),e.jsxs("p",{className:"hint",children:["Key from ",e.jsx("a",{href:"https://cloud.cerebras.ai/platform/api-keys",target:"_blank",rel:"noopener",children:"cloud.cerebras.ai"}),". Uses ",e.jsx("strong",{style:{color:"#c4b5fd"},children:"Llama 3.3 70B"})," — world's fastest inference, generous free tier."]})]}),t==="grok"&&e.jsxs(e.Fragment,{children:[e.jsx("label",{className:"label",htmlFor:"grok-key",children:"Groq API key"}),e.jsx("input",{id:"grok-key",className:"input",type:"password",value:d,onChange:r=>p(r.target.value),placeholder:"gsk_…",autoComplete:"off"}),e.jsxs("p",{className:"hint",children:["Free key from ",e.jsx("a",{href:"https://console.groq.com/keys",target:"_blank",rel:"noopener",children:"console.groq.com"}),". Uses ",e.jsx("strong",{style:{color:"#c4b5fd"},children:"Llama 3.3 70B"})," — fully free, extremely fast inference."]})]}),t==="claude"&&e.jsxs(e.Fragment,{children:[e.jsx("label",{className:"label",htmlFor:"claude-key",children:"Anthropic API key"}),e.jsx("input",{id:"claude-key",className:"input",type:"password",value:m,onChange:r=>b(r.target.value),placeholder:"sk-ant-…",autoComplete:"off"}),e.jsxs("p",{className:"hint",children:["Get a free key from ",e.jsx("a",{href:"https://console.anthropic.com/settings/keys",target:"_blank",rel:"noopener",children:"console.anthropic.com"}),". Uses ",e.jsx("strong",{style:{color:"#c4b5fd"},children:"claude-haiku-4-5"})," — fastest model, generous free tier."]})]}),t==="gemini"&&e.jsxs(e.Fragment,{children:[e.jsx("label",{className:"label",htmlFor:"gemini-key",children:"Gemini API key"}),e.jsx("input",{id:"gemini-key",className:"input",type:"password",value:g,onChange:r=>x(r.target.value),placeholder:"AIzaSy…",autoComplete:"off"}),e.jsxs("p",{className:"hint",children:["Free key from ",e.jsx("a",{href:"https://aistudio.google.com/apikey",target:"_blank",rel:"noopener",children:"aistudio.google.com"})," — create a ",e.jsx("strong",{style:{color:"#c4b5fd"},children:"new project"})," to get free tier access."]})]}),t==="openai"&&e.jsxs(e.Fragment,{children:[e.jsx("label",{className:"label",htmlFor:"openai-key",children:"OpenAI API key"}),e.jsx("input",{id:"openai-key",className:"input",type:"password",value:u,onChange:r=>h(r.target.value),placeholder:"sk-…",autoComplete:"off"}),e.jsxs("p",{className:"hint",children:["Key from ",e.jsx("a",{href:"https://platform.openai.com/api-keys",target:"_blank",rel:"noopener",children:"platform.openai.com"}),". Uses gpt-4o-mini — costs ~$0.001 per session analysis."]})]}),T&&e.jsxs("div",{className:"status-ok",children:[e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",children:e.jsx("path",{d:"M20 6L9 17l-5-5",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),"Saved — analyzing your tabs now…"]}),e.jsxs("div",{style:{display:"flex",gap:10,marginTop:20},children:[e.jsxs("button",{type:"button",className:"btn-save",onClick:M,disabled:!W(),children:[e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",children:[e.jsx("path",{d:"M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z",stroke:"currentColor",strokeWidth:"1.8",strokeLinejoin:"round"}),e.jsx("path",{d:"M17 21v-8H7v8M7 3v5h8",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round"})]}),"Save & analyze now"]}),(d||m||g||u||f||k)&&e.jsx("button",{type:"button",className:"btn-danger",onClick:_,children:"Clear keys"})]})]}),c==="blocklist"&&e.jsxs("div",{className:"card",children:[e.jsx("div",{className:"card-title",children:"Privacy — blocked domains"}),e.jsx("p",{style:{fontSize:12.5,color:"#4b5568",lineHeight:1.6,marginBottom:20},children:"TabMind will never extract page text from these domains. Tab titles and URLs are still used for session summaries."}),e.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:6,marginBottom:16},children:v.map(r=>e.jsxs("button",{type:"button",className:"blocklist-tag",onClick:()=>O(r),title:"Click to remove",children:[r," ",e.jsx("span",{style:{opacity:.5,fontSize:10},children:"×"})]},r))}),e.jsxs("div",{style:{display:"flex",gap:8},children:[e.jsx("input",{className:"input",style:{fontFamily:"inherit",flex:1},placeholder:"example.com",value:N,onChange:r=>C(r.target.value),onKeyDown:r=>r.key==="Enter"&&z()}),e.jsx("button",{type:"button",className:"btn-save",style:{marginTop:0,flexShrink:0},onClick:z,disabled:!N.trim(),children:"Add"})]}),e.jsx("button",{type:"button",onClick:D,style:{marginTop:14,fontSize:12,color:"#4b5568",background:"none",border:"none",cursor:"pointer",padding:0},children:"Reset to defaults ↺"})]}),c==="about"&&e.jsxs("div",{className:"card",children:[e.jsx("div",{className:"card-title",children:"Session settings"}),[["Snapshot interval","90 seconds"],["History kept","50 sessions"],["Session reset","5 min idle"],["Notes storage","chrome.storage.sync"],["Keys storage","chrome.storage.sync (encrypted by Chrome)"],["Snapshots storage","chrome.storage.local"],["Tab grouping","automatic, via chrome.tabGroups"],["Keyboard shortcut","⌘⇧K / Ctrl+Shift+K"]].map(([r,a])=>e.jsxs("div",{className:"row",children:[e.jsx("span",{className:"row-key",children:r}),e.jsx("span",{className:"row-val",children:a})]},r)),e.jsx("div",{style:{display:"flex",gap:16,marginTop:20},children:[{label:"Source code",href:"https://github.com/thribhuvan003/tabmind"},{label:"Report issue",href:"https://github.com/thribhuvan003/tabmind/issues"}].map(({label:r,href:a})=>e.jsxs("a",{href:a,target:"_blank",rel:"noopener noreferrer",style:{fontSize:12.5,color:"#4b5568",textDecoration:"none"},onMouseEnter:n=>{n.currentTarget.style.color="#94a3b8"},onMouseLeave:n=>{n.currentTarget.style.color="#4b5568"},children:[r," →"]},r))})]})]})}U.createRoot(document.getElementById("root")).render(e.jsx(H.StrictMode,{children:e.jsx($,{})}));
